...
/*float MagOffset[3] = { -28.495816, -5.429481, -40.521113}; // Offsets pour les axes x, y et z; trouvés par la nouvelle calibration
float mCal[3][3] =
{
  { +1.161111, -0.050614, -0.103080},                       // valeurs pour calibrer
  { -0.050614, +0.968724, -0.054117},
...
float mCal[3][3] =
{
  { +0.996029, -0.066015, -0.015739},                       // valeurs pour calibrer
  { -0.066015, +1.135693, -0.129009},
  { -0.015739, -0.129009, +0.931778}
};
